...
// static ssize_t rio_read(rio_t *rp, char *usrbuf, size_t n) __attribute__ ((section (".isolate_target")));
// void log_access(int status, struct sockaddr_in *c_addr, http_request *req) __attribute__ ((section (".isolate_target")));
