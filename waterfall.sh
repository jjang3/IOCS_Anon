...
opt -load $LIB_DIR/lib/"lib"$2.so -load-pass-plugin $LIB_DIR/lib/"lib"$2.so -passes=waterfall -S $RESULTS_INPUT_DIR/$1.bc  -taint $TAINT_SCRIPTS_DIR/$1/$1_list.out  -o $RESULTS_INPUT_DIR/"$1"_modified.ll
